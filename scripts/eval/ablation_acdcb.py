...
def resolve_paths() -> dict[str, Path]:
    ...
    return {
        ...
        "ablation_json": metrics_dir / "ablation_results_acdcb.json",
        "ablation_oof_csv": pred_dir / "ablation_oof_predictions.csv",
    }
...
def optimize_weights_with_trace(
    P: np.ndarray,
    y: np.ndarray,
    maxiter: int = 500,
